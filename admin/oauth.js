export async function handler(event) {
  ...
  if (path.endsWith('/callback')) {
    ...
    const params = new URLSearchParams({ client_id: clientId, client_secret: clientSecret, code, redirect_uri: redirectUri });
